...
public class DebitTransactionCreatedNotificationHandler : INotificationHandler<CashFlowCreatedEventNotification>
{
    ...
    public DebitTransactionCreatedNotificationHandler(IAppQueryDbContext queryDbContext, IDbOperationConfiguration dbOperationConfiguration, IDailySummaryRepository summaryRepository, IUnitOfWork unitOfWork)
    {
    ...
    {
        if (notification.TransactionType != TransactionType.Debit) return;
        ...
        dailySummary.AddDebit(notification.Amount);
